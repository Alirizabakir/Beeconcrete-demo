<template>
  <!--begin::Footer-->
  <div class="footer pt-4 d-flex flex-lg-column mt-20" id="kt_footer">
    <div class="mb-0">
      <!--begin::Curve top-->
      ...
      <div class="landing-dark-bg pt-20">
        ...
        <div class="container overflow-hidden">
          <!--begin::Row-->
          <div class="row px-0 py-10 py-lg-20">
            <!--begin::Col-->
            <div class="col-lg-6 pe-lg-16 mb-10 mb-lg-0">
              ...
              <div class="rounded landing-dark-border p-9 mb-10">
                ...
                <span class="fw-normal fs-4 text-gray-700">Email us to
									<a  class="text-white opacity-50 text-hover-primary">support@beeconcrete.com</a></span>
                <!--end::Text-->
              </div>
              <!--end::Block-->
              <!--begin::Block-->
            ...
            <div class="col-lg-6 ps-lg-16">
              ...
              <div class="d-flex justify-content-center">
                ...
                <div class="d-flex fw-semibold flex-column me-20">
                  <!--begin::Subtitle-->
                  <h4 class="fw-bold text-gray-400 mb-6">More for Beeconcrete</h4>
                  <!--end::Subtitle-->
                  <!--begin::Link-->
                  ...
                  <!--end::Link-->
                  <!--begin::Link-->
                  <a class="text-white opacity-50 text-hover-primary fs-5 mb-6">Video Tuts</a>
                  <!--end::Link-->
                  <!--begin::Link-->
                  <a class="text-white opacity-50 text-hover-primary fs-5 mb-6">Changelog</a>
                  <!--end::Link-->
                  <!--begin::Link-->
                  <a class="text-white opacity-50 text-hover-primary fs-5 mb-6">Support Forum</a>
                  <!--end::Link-->
                  <!--begin::Link-->
        ...
        <div class="container">
          <!--begin::Wrapper-->
          <div class="d-flex flex-column flex-md-row flex-stack py-4 py-lg-4">
            <!--begin::Copyright-->
            <div class="d-flex align-items-center order-2 order-md-1">
              <!--begin::Logo-->
              <a href="../../demo41/dist/landing.html">
                <img alt="Logo" src="/media/logos/beeconcrete.png" class="h-15px h-md-70px" />
              </a>
              <!--end::Logo image-->
              <!--begin::Logo image-->
              <span class="mx-5 fs-6 fw-semibold text-gray-600 pt-1" href="https://beeconcrete.com">&copy; 2023 Beeconcrete Inc.</span>
              <!--end::Logo image-->
            </div>
            <!--end::Copyright-->
            <!--begin::Menu-->
