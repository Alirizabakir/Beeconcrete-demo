<template>
  ...
  >
    <!--begin::Menu-->
    <div
        class="menu menu-rounded menu-column menu-lg-row menu-active-bg-dark menu-title-gray-700 menu-state-primary menu-arrow-gray-400 fw-semibold my-5 my-lg-0 align-items-stretch px-2 px-lg-0"
        id="#kt_header_menu"
        data-kt-menu="true"
    >
      <template v-for="(item, i) in MainMenuConfig" :key="i">
          ...
          <template v-for="(menuItem, j) in item.pages" :key="j">
            <div v-if="menuItem.heading" class="menu-item me-lg-1">
              <router-link
                  ...
                  active-class="active"
              >
                <span class="menu-title text-gray-800 fw-bold fs-4">{{
        ...
        >
          ...
          >
            <span class="menu-title text-gray-800 fw-bold fs-4">{{ translate(item.heading) }}</span>
