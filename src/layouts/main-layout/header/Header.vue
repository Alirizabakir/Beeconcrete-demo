<template>
  ...
  >
    ...
    <div
      ...
      class="d-flex align-items-center px-4 px-lg-4"
    >
      <!--begin::Aside mobile toggle-->
      <div class="d-flex topbar align-items-center d-lg-none me-3" title="Show aside menu">
      ...
      <!--begin::Mobile logo-->
      <div class="header-logo me-md-10 flex-grow-1 flex-lg-grow-0">
        <router-link to="/dashboard" class="d-inline-flex bg-primary rounded-circle p-1">
          <img
            alt="Logo"
            :src="getAssetPath('media/logos/beeconcrete.png')"
