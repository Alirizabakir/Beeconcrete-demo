<template>
  ...
  <div class="page d-flex flex-row flex-column-fluid">
    <div id="kt_wrapper" class="wrapper d-flex flex-column flex-row-fluid">
      ...
      <div
        id="kt_content"
        class="d-flex flex-column-fluid align-items-start mt-4"
        :class="{
      ...
      >
        ...
        <!-- begin:: Content Body -->
        <div class="content flex-row-fluid rounded-start-5 rounded-lg-start-0 rounded-end-5 bg-body p-5 p-lg-8 container-xxl shadow">
          <!-- begin:: Content Head -->
          <KTToolbar v-if="subheaderDisplay" />
          <!-- end:: Content Head -->
          <div style="height: 1px" class="bg-primary bg-opacity-50 my-6 rounded-circle"></div>
          <RouterView />
        </div>
        <!-- end:: Content Body -->
      </div>
