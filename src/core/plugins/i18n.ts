...
const messages = {
  en: {
    ...
    products: "Products",
    pots: "Pots",
    beeCollection: "Bee Collection",
    hiveCollection: "Hive Collection",
    honeycombCollection: "Honeycomb Collection",
    queenCollection: "Queen Collection",
    furniture: "Furniture",
    columnCollection: "Column Collection",
    tableCollection: "Table Collection",
    sideboardCollection: "Sideboard Collection",
    long: "Long",
    covering: "Covering",
    about: "About",
    social: "Social",
