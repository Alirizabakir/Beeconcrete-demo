  ...
  setup() {
    const questions = ref<Array<IQuestion>>([
      ...
      },
      {
        ...
        summary:
          "could not get demo7 working from latest beeconcrete version. Had a lot of issues installing, I had to downgrade my npm to 6.14.4 as someone else recommended here in the comments, this goot it to compile but when I ran it, the browser showed errors TypeErr..",
